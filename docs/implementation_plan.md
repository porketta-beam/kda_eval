...
│   │   │   ├── page.jsx                  # ★ 총점 대시보드 (항목 목록 + 집계 설정)
│   │   │   ├── students/page.jsx         # 학생 명단 관리 + 팀 관리
│   │   │   └── eval/[categoryId]/
│   │   │       └── page.jsx              # ★ 항목별 점수 입력 + 인라인 설정 + ConflictDialog
│   │   └── api/
│   │       └── cohorts/
...
│   │   ├── eval/
│   │   │   ├── ScoreTable.jsx            # 점수 입력 테이블 (리프/복합 공용)
